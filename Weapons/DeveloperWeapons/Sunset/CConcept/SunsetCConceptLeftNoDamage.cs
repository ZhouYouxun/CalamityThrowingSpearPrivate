...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.Sunset.CConcept
{
    internal class SunsetCConceptLeftNoDamage : ModProjectile
    {
        ...
        public override string Texture => "CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/疯齿丑绅";
    ...
    List<int> overPlayers, List<int> overWiresUI)
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (index == 0)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/疯齿丑绅").Value;
            else if (index == 1)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/葬灵木渊").Value;
            else if (index == 2)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/四夜轮回").Value;
            else if (index == 3)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/挖腹背鳍").Value;
            else if (index == 4)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/千萃碎年").Value;
            else if (index == 5)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/抚脑幻听").Value;
            else if (index == 6)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/天之缚权").Value;
            else if (index == 7)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/白烛荡想").Value;
            else if (index == 8)
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/托泪逆梦").Value;
            else
                texture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/掩手狂目").Value;
