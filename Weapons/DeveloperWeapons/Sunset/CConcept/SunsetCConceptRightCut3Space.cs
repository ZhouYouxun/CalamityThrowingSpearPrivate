...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.Sunset.CConcept
{
    internal class SunsetCConceptRightCut3Space : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/RC/空间";

        public override bool PreDraw(ref Color lightColor)
        {
            Texture2D texture = ModContent.Request<Texture2D>(
                "CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/CConcept/RC/空间"
            ).Value;
