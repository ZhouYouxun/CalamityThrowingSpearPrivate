...
using CalamityThrowingSpear.Weapons.DeveloperWeapons.Sunset.ASunset;
...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.Sunset
{
    public class Sunset : ModItem, ILocalizedModType
    {
        ...
        public override void Load()
        {
            if (!Main.dedServ)
            {
                TextureA = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/SunsetA").Value;
                TextureB = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/SunsetB").Value;
                TextureC = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/SunsetC").Value;
            }
        }
        ...
        {
            string basePath = "CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/";
