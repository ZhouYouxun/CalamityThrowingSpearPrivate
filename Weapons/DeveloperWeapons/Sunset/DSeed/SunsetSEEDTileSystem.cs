        ...
        private Texture2D GetStageTexture(int stage)
        {
            return stage switch
            {
                0 => ModContent.Request<Texture2D>(
                    "CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/DSeed/SunsetSEEDTile1").Value,
                1 => ModContent.Request<Texture2D>(
                    "CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/DSeed/SunsetSEEDTile2").Value,
                2 => ModContent.Request<Texture2D>(
                    "CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/DSeed/SunsetSEEDTile3").Value,
                _ => ModContent.Request<Texture2D>(
                    "CalamityThrowingSpear/Weapons/DeveloperWeapons/Sunset/DSeed/SunsetSEEDTile4").Value,
            };
        }
