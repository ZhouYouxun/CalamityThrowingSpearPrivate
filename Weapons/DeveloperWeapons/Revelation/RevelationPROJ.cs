...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.Revelation
{
    public class RevelationPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityThrowingSpear/Weapons/DeveloperWeapons/Revelation/Revelation";
