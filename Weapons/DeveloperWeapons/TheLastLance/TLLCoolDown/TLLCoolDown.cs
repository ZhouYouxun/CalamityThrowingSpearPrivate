...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.TheLastLance
{
    public class TLLCoolDown : ModSystem
    {
        ...
        private void DrawCooldownIcon()
        {
            ...
            Texture2D iconTexture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/TheLastLance/TLLCoolDown").Value;
            Texture2D overlayTexture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/TheLastLance/TLLCoolDownOverlay").Value;
