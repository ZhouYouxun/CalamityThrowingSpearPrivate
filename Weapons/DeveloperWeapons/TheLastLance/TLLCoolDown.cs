...
//namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.TheLastLance
//{
//    public class TLLCoolDown : CooldownHandler
//    {
//        public static new string ID => "TLLCoolDown";
//        public override bool ShouldDisplay => true;
//        public override LocalizedText DisplayName => CalamityUtils.GetText("UI.Cooldowns.TLLCoolDown" + (instance.timeLeft > 1500 ? "Active" : "Cooldown"));
//        public override string Texture => instance.timeLeft > 1500 ? "CalamityThrowingSpear/Weapons/DeveloperWeapons/TheLastLance/TLLCoolDownActive" : "CalamityThrowingSpear/Weapons/DeveloperWeapons/TheLastLance/TLLCoolDown";
//        public override string OutlineTexture => "CalamityThrowingSpear/Weapons/DeveloperWeapons/TheLastLance/TLLCoolDownOutline";
//        public override string OverlayTexture => "CalamityThrowingSpear/Weapons/DeveloperWeapons/TheLastLance/TLLCoolDownOverlay";
