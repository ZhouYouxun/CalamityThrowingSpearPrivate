...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.StarsofDestiny
{
    internal class XiaoZhiTiaoSoD : ModItem
    {
        ...
        {
            return DeveloperWeaponInfoUI.ShootInfoPanel(player, source, DeveloperWeaponInfoPanelId.StarsOfDestiny);
        }
