...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.ElementalArkJav
{
    public class ElementalArkJavBlast : ModProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                Texture2D frontBlade = Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/ElementalArkJav/EAJFragment").Value;
                Texture2D backBlade = Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/ElementalArkJav/EAJBlade").Value;
