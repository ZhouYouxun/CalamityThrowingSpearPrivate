...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.FinishingTouch
{
    public class FinishingTouchEPROJ : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/FinishingTouch";
        ...
        public override void AI()
        {
            ...
            if (hasCollidedWithTile)
            {
                ...
                for (int i = 0; i < Main.maxPlayers; i++)
                {
                    ...
                    {
                        Projectile.Kill();
                        SoundEngine.PlaySound(new SoundStyle("CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/TheSound/mega") with { Volume = 2f });
                        return;
                    }
                }
            }
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/TheSound/RayquazaRoar") with { Volume = 2f });
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/TheSound/RayquazaRoar") with { Volume = 2.5f }, Projectile.Center);
