...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.FinishingTouch
{
    internal class FinishingTouchEcho : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/FinishingTouchEcho";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D lightTexture = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/FinishingTouchEcho").Value;
