...
namespace CalamityThrowingSpear.Weapons.DeveloperWeapons.FinishingTouch.FTDragon
{
    public class FinishingTouchDragon : ModProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D headTex = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/FTDragon/FinishingTouchDragon1Head").Value;
            Texture2D bodyTex = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/FTDragon/FinishingTouchDragon2Body").Value;
            Texture2D tailTex = ModContent.Request<Texture2D>("CalamityThrowingSpear/Weapons/DeveloperWeapons/FinishingTouch/FTDragon/FinishingTouchDragon3Tail").Value;
