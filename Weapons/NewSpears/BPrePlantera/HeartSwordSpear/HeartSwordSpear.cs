...
using CalamityThrowingSpear.Weapons.NewSpears.CPreMoodLord.TidalMechanicsSpear;
using System;
...
{
    internal class HeartSwordSpear : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<HeartSwordSpearHoldOut>(); // 使用新的弹幕
