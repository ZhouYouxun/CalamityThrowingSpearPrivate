...
{
    public class FinishingTouchBALL : ModProjectile, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            // 检查 Main.zenithWorld 模式以调整时间和穿透属性
            Projectile.penetrate = Main.zenithWorld ? -1 : 1;
            Projectile.timeLeft = Main.zenithWorld ? 180 : 360;
