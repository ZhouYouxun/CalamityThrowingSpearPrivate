...
{
    public class SunEssenceJavBEAM : BaseLaserbeamProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            float laserBodyLength = LaserLength * Projectile.scale;
            float laserOffset = middleFrameArea.Height * Projectile.scale;
            float incrementalBodyLength = 0f;

            while (incrementalBodyLength < laserBodyLength)
            {
