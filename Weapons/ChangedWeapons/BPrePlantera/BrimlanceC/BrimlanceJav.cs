...
{
    public class BrimlanceJav : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BrimlanceJavPROJ>(); // 使用新的弹幕
        ...
        //    recipe.AddIngredient<Brimlance>();
        //    recipe.Register();
        //}
    }
}
