...
{
    public class EarthenJav : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<EarthenJavPROJ>(); // 使用新的弹幕
        ...
        //    recipe.AddIngredient<EarthenPike>();
        //    recipe.Register();
        //}
    }
}
