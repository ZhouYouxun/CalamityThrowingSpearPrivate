...
{
    public class ViolenceJav : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<ViolenceJavPROJ>(); // 使用新的弹幕
