...
{
    public class OrangeSLASH : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            {
                Particle spark2 = new GlowSparkParticle(Projectile.Center, new Vector2(0.1f, 0.1f).RotatedByRandom(100), false, 12, Main.rand.NextFloat(0.03f, 0.05f), Color.OrangeRed, new Vector2(2, 0.5f), true);
